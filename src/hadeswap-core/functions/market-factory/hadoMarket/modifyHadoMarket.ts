...
type ModifyHadoMarket = (params: {
  ...
  accounts: {
    ...
    validationAdapterAuthority: web3.PublicKey;
  };

  sendTxn: (transaction: web3.Transaction, signers: web3.Signer[]) => Promise<void>;
}) => Promise<{ account: null; instructions: web3.TransactionInstruction[]; signers: web3.Signer[] }>;

export const modifyHadoMarket: ModifyHadoMarket = async ({ programId, connection, accounts, sendTxn }) => {
